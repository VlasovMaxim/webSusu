...
SECRET_KEY = 'django-insecure-e$85x!80egfv#ujdr43!h7+glj&7i28+y4itgo%_53jg%1$4wu'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bookstore',           # имя созданной базы данных
        'USER': 'root',        # замените на имя пользователя MySQL
        'PASSWORD': 'Hlmg/7X]f_PH0BM',    # замените на пароль MySQL
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
